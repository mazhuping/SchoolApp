...
export default function getMenus(userId) {
    ...
    return Promise.resolve( [
       {"key":"rightmanage","parentKey":"","path":"","text":"AuthorityManage","icon":"ant-design","url":"","target":"","order":1000,"type":1,"code":"rightmanage","local":"sysManage"},
        ...
        {"key":"TotalClassHourListForSchool","parentKey":"statistics","path":"/TotalClassHourListForSchool","text":"总课时消耗(校区)","icon":"database","url":"","target":"","order":963,"type":1,"code":"studentConsult","local":"studentConsult"},
        {"key":"TotalClassHourListForDate","parentKey":"statistics","path":"/TotalClassHourListForDate","text":"总课时消耗（时间）","icon":"database","url":"","target":"","order":963,"type":1,"code":"studentConsult","local":"studentConsult"},
        {"key":"goonstudent","parentKey":"statistics","path":"/InsuffHourStus","text":"续课学员","icon":"database","url":"","target":"","order":962,"type":1,"code":"studentConsult","local":"studentConsult"},
        {"key":"teacherclasshour","parentKey":"statistics","path":"/classhourteacher","text":"教师课时","icon":"database","url":"","target":"","order":961,"type":1,"code":"studentConsult","local":"studentConsult"},
        {"key":"studentclasshour","parentKey":"statistics","path":"/classhourstudent","text":"学员课时","icon":"database","url":"","target":"","order":960,"type":1,"code":"studentConsult","local":"studentConsult"},
        {"key":"surplusmoney","parentKey":"statistics","path":"/BalanceMoney","text":"剩余金额","icon":"database","url":"","target":"","order":958,"type":1,"code":"studentConsult","local":"studentConsult"},
        {"key":"teacherClassstatus","parentKey":"statistics","path":"/TeacherClassSituation","text":"教师带班情况","icon":"database","url":"","target":"","order":957,"type":1,"code":"studentConsult","local":"studentConsult"},
        {"key":"classschduletime","parentKey":"statistics","path":"/TimeSchedule","text":"时间排班","icon":"database","url":"","target":"","order":956,"type":1,"code":"studentConsult","local":"studentConsult"},
        {"key":"classschduleteacher","parentKey":"statistics","path":"/TeacherSchedule","text":"教师排班","icon":"database","url":"","target":"","order":955,"type":1,"code":"studentConsult","local":"studentConsult"},
        {"key":"classschduleClass","parentKey":"statistics","path":"/ClassSchedule","text":"课时排班","icon":"database","url":"","target":"","order":954,"type":1,"code":"studentConsult","local":"studentConsult"},
        ...
        {"key":"studentimport","parentKey":"dataimport","path":"/ImportStudents","text":"学生导入","icon":"database","url":"","target":"","order":947,"type":1,"code":"studentConsult","local":"studentConsult"},
        ...
        {"key":"attendancelist","parentKey":"attendancemanage","path":"/SignedManage","text":"考勤管理","icon":"database","url":"","target":"","order":944,"type":1,"code":"studentConsult","local":"studentConsult"},
        {"key":"SignList","parentKey":"attendancemanage","path":"/SignList","text":"考勤列表","icon":"database","url":"","target":"","order":943,"type":1,"code":"studentConsult","local":"studentConsult"},
        {"key":"attendancehistory","parentKey":"attendancemanage","path":"/SignHistoryList","text":"考勤历史","icon":"database","url":"","target":"","order":942,"type":1,"code":"studentConsult","local":"studentConsult"},
        ...
        {"key":"outincommdity","parentKey":"commoditymanage","path":"/CommodityInOutList","text":"商品存取","icon":"database","url":"","target":"","order":936,"type":1,"code":"studentConsult","local":"studentConsult"},
