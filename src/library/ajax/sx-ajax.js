...
export default class SXAjax {
    ...
    constructor({
        ...
        // this.instance = axios.create({headers: {'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmEiOiJhZG1pbjEiLCJyb2wiOiJTeXN0ZW1NYW5hZ2VyUm9sZSIsImV4cCI6MTU3MDgwMTc2MSwiaXNzIjoiZGF0YWxhYmNoaW5hIiwiYXVkIjoid3d3LmRhdGFsYWJjaGluYS5jb20ifQ.Ta0yeDDwlxLFu_S8lNVKoyFygNHEvO7Hv_UX6QZotzo'}});
    ...
    setDefaultOption(instance) {
        ...
        // instance.defaults.baseURL = 'http://192.168.65.17:4002';
        instance.defaults.baseURL = '/';
        instance.defaults.withCredentials = true; // 跨域携带cookie
        // instance.defaults.headers.get['Authorization']='Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmEiOiJhZG1pbjEiLCJyb2wiOiJTeXN0ZW1NYW5hZ2VyUm9sZSIsImV4cCI6MTU3MDgwMTc2MSwiaXNzIjoiZGF0YWxhYmNoaW5hIiwiYXVkIjoid3d3LmRhdGFsYWJjaGluYS5jb20ifQ.Ta0yeDDwlxLFu_S8lNVKoyFygNHEvO7Hv_UX6QZotzo';
    }
